...
# $$
#
# with the crucial extra feature that $r(X, \pi)$ can only be evaluated by *simulating* it — there is no formula we could optimize directly. This setting is called simulation optimization (also: optimization by simulation, simulation-based optimization, or simopt).
#
