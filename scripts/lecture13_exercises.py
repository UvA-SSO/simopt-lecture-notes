...
# %% [markdown]
# The smaller exercises embedded in Lecture 13's notebooks check what you just read. This
# notebook is for the larger, independent exercises for Lecture 13: to be added.
