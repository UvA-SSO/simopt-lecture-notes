...
# %% [markdown]
# The smaller exercises embedded in Lecture 12's notebooks check what you just read. This
# notebook is for the larger, independent exercises for Lecture 12: to be added.
