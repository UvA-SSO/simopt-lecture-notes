...
# %% [markdown]
# ### Chapter 7 — Combinatorial Optimization (§7.1-§7.3)
#
...
# %% [markdown]
# ## Source map
# - **Schedule topic(s):** Algorithms and heuristics (§7.1-§7.3)
# - **Book source(s):** Koole, *An Introduction to Business Analytics* (2019) — Chapter 7 "Combinatorial Optimization", §7.1-§7.3
...
#
# > **Uncertainty:** the book's own chapter/section title is "Combinatorial Optimization" (§7.1 shortest path, §7.2 maximum flow, §7.3 traveling salesman), which differs from the schedule's label "Algorithms and heuristics" — the section numbers map 1:1, only the descriptive label differs.
