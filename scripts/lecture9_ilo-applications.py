...
# %% [markdown]
# ### Chapter 6 — Linear Optimization (§6.5)
...
# %% [markdown]
# ## Source map
# - **Schedule topic(s):** Applications of (integer) linear optimization (§6.5)
# - **Book source(s):** Koole, *An Introduction to Business Analytics* (2019) — §6.5 "Example ILO problems"
