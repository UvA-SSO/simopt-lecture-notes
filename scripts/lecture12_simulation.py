...
# %% [markdown]
# ## Source map
# - **Schedule topic(s):** Simulation (Ch. 5)
# - **Book source(s):** Koole, *An Introduction to Business Analytics* (2019) — Chapter 5 "Simulation" (whole)
# - **Errata applied:** none
#
# > Preceded by [Lecture 12: Variability (Recap)](lecture12_variability-recap.ipynb), Chapter 3, per the schedule's "Before lecture" prep reading.
