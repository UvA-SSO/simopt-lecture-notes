...
# %% [markdown]
# ### Chapter 6 — Linear Optimization (§6.4)
...
# %% [markdown]
# ## Source map
# - **Schedule topic(s):** Integer linear optimization (§6.4)
# - **Book source(s):** Koole, *An Introduction to Business Analytics* (2019) — §6.4 "Integer problems"
