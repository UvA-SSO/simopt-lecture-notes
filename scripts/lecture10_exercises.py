...
# %% [markdown]
# The smaller exercises embedded in Lecture 10's notebooks check what you just read. This
# notebook is for the larger, independent exercises for Lecture 10: to be added.
