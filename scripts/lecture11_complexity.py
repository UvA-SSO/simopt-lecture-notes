...
# %% [markdown]
# ### Chapter 7 — Combinatorial Optimization (§7.4)
...
# %% [markdown]
# ## Source map
# - **Schedule topic(s):** Complexity (§7.4)
# - **Book source(s):** Koole, *An Introduction to Business Analytics* (2019) — Chapter 7 "Combinatorial Optimization", §7.4
# - **Errata applied:** none
