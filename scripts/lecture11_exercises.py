...
# %% [markdown]
# The smaller exercises embedded in Lecture 11's notebooks check what you just read. This
# notebook is for the larger, independent exercises for Lecture 11: to be added.
